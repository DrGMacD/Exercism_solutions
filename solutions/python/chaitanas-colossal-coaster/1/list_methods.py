...
def find_my_friend(queue, friend_name):
    ...
    if friend_name in queue:
        ...
        return "Friend is not found in the queue."

print(find_my_friend(queue=["Natasha", "Steve", "T'challa", "Wanda", "Rocket"], friend_name="Steve"))
print(find_my_friend(queue=["Natasha", "Steve", "T'challa", "Wanda", "Rocket"], friend_name="Bobby"))
...
def remove_the_mean_person(queue, person_name):
    ...
    if person_name in queue:
        ...
        return "Person not found in the queue."
    return queue
...
print(how_many_namefellows(queue=["Natasha", "Steve", "Eltran", "Natasha", "Rocket"], person_name="Rocket"))
